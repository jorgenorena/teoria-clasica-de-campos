...
\derivation{Esto se deduce a partir de}
\[
  J_+J_-|j-n\rangle=(2j-n)(n+1)|j-n\rangle,
\]
\derivation{que demostramos por recurrencia:}
...
Nos da infinitos vectores. Pero si $j$ toma algunos valores especiales, la normalización $\sqrt{(2j-n)n}$ se hace cero luego de un número finito de ``bajadas'':
\[
  n=2j.
\]
