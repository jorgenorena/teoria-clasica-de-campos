...
\begin{center}
  ...
  \caption{Tabla manuscrita de campos y números cuánticos. En rojo la masa en MeV, en verde el espín, en azul la hipercarga, en violeta el isospín, y en naranja la carga de color cuando la hay.}
  \end{figure}
\end{center}

Masa en $\mathrm{MeV}/c^2$, spin, hipercarga débil, isospín débil, representación de color ($1$ cuando no se escribe).
